...
# prepare the live_palette installation
WORKDIR /live_palette
...
COPY --from=builder --chown=nobody:root /live_palette/app/_build/${MIX_ENV}/rel/live_palette_demo ./
